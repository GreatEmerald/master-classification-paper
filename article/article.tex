...
% Each followed by [id=<your id>, comment={Comment, optional}]
\usepackage[xcolor={usenames,dvipsnames}]{changes}
\definechangesauthor[color=OliveGreen]{dm}
