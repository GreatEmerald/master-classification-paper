...
The entire archive of the Proba-V 100 m Level 3 Top-of-Canopy 5-day composite product was used for this study.
...
Each of these \glspl{VI} was then composited into a single image that represents the leaf-on season of 2015.
...
The NASA \ac{GLSDEM} 90 m product was used as the elevation covariate.
In addition, terrain parameters were calculated out of elevation: slope, aspect, roughness and \ac{TPI}.
All terrain covariates were then resampled to the Proba-V grid.

\subsubsection{Climate covariates}

The climate data from WorldClim 2.0 30 s product was used.
...
The latitude, longitude and absolute latitude of the points were also included as covariates.
