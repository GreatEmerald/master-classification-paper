...
After determining the baseline methods with the highest accuracy, we tested our newly proposed multi-step approach on \gls{RF} regression, comparing the effect with that of median voting instead of mean voting.
