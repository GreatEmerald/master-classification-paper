...
Results showed that the random forest regression model reached the lowest RMSE of 17.3\%. Lowest MAE (7.9\%) and highest overall accuracy (72±2\%) was achieved using random forest regression with our proposed three-model approach and median vote.
